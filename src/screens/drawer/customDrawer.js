        ...
        <SafeAreaView style={{ flex: 1 }}>
            <ScrollView>
                ...
                <View style={style.main}>
                    ...
                    <TouchableOpacity onPress={() => setWomanDropdown(!womanDropdwon)}>
                        <View style={style.dropDown}>
                            <View>
                                <Text style={{ color: 'black', fontSize: responsiveFontSize(2.7) }}>Woman</Text>
                            </View>
                            <View>
                ...
                {/* <TouchableOpacity onPress={() => setOpenNew(!openNew)}>
                        <View style={style.one}>
                            <Text style={{ color: '#6B695E', fontSize: responsiveFontSize(2.4) }}>New</Text>
                    ...
                    {openNew ? (
                        <View>
                            <FlatList data={data} renderItem={({ item, index }) => {
                                return (
                                    <TouchableOpacity>
                                        <Text style={{ color: 'black', padding: 10, fontSize: responsiveFontSize(2), margin: 3, borderBottomColor: '#6B695E', borderBottomWidth: .7 }}>{item.productName}</Text>
                                    </TouchableOpacity>
                                )
                            }} />
                        </View>
                ...
                <View style={{ marginTop: 380 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', margin: 15 }}>
                        ...
                        <Text style={{ color: 'black', fontSize: responsiveFontSize(2.3), fontWeight: 'bold', marginLeft: 5 }}>0317-2930029</Text>
                    </View>
                    <View style={{ flexDirection: 'row', alignItems: 'center', margin: 15 }}>
                        <Icon name='location-on' size={30} color='black' />
                        <Text style={{ color: 'black', fontSize: responsiveFontSize(2.3), fontWeight: 'bold', marginLeft: 5 }}>Store Locator</Text>
                    </View>
